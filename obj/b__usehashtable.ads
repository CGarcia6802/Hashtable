...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_usehashtable" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#c25ed3cb#;
   pragma Export (C, u00001, "usehashtableB");
   ...
   u00092 : constant Version_32 := 16#03e83d1c#;
   pragma Export (C, u00092, "ada__numerics__elementary_functionsB");
   u00093 : constant Version_32 := 16#61baa04a#;
   pragma Export (C, u00093, "ada__numerics__elementary_functionsS");
   u00094 : constant Version_32 := 16#edf015bc#;
   pragma Export (C, u00094, "ada__numerics__aux_floatS");
   u00095 : constant Version_32 := 16#effcb9fc#;
   pragma Export (C, u00095, "ada__numerics__aux_linker_optionsS");
   u00096 : constant Version_32 := 16#8272e858#;
   pragma Export (C, u00096, "ada__numerics__aux_long_floatS");
   u00097 : constant Version_32 := 16#8333dc5f#;
   pragma Export (C, u00097, "ada__numerics__aux_long_long_floatS");
   u00098 : constant Version_32 := 16#33fcdf18#;
   pragma Export (C, u00098, "ada__numerics__aux_short_floatS");
   u00099 : constant Version_32 := 16#8aea7eed#;
   pragma Export (C, u00099, "system__exn_fltS");
   u00100 : constant Version_32 := 16#ecc88e78#;
   pragma Export (C, u00100, "system__fat_fltS");
   ...
   u00133 : constant Version_32 := 16#0f9a77f5#;
   pragma Export (C, u00133, "system__direct_ioB");
   u00134 : constant Version_32 := 16#8d9bb72a#;
   pragma Export (C, u00134, "system__direct_ioS");
   u00135 : constant Version_32 := 16#3720d920#;
   pragma Export (C, u00135, "system__img_biuS");
   u00136 : constant Version_32 := 16#6424aad3#;
   ...
   u00138 : constant Version_32 := 16#cf061228#;
   pragma Export (C, u00138, "system__float_controlS");
   u00139 : constant Version_32 := 16#2549028f#;
   pragma Export (C, u00139, "system__img_utilB");
   u00140 : constant Version_32 := 16#44802e3b#;
   pragma Export (C, u00140, "system__img_utilS");
   u00141 : constant Version_32 := 16#690df0ad#;
   pragma Export (C, u00141, "system__powten_fltS");
   u00142 : constant Version_32 := 16#c90890af#;
   pragma Export (C, u00142, "system__img_lfltS");
   u00143 : constant Version_32 := 16#cafa8775#;
   pragma Export (C, u00143, "system__fat_lfltS");
   u00144 : constant Version_32 := 16#b684afd1#;
   pragma Export (C, u00144, "system__img_lluS");
   u00145 : constant Version_32 := 16#0be1c959#;
   ...
   u00150 : constant Version_32 := 16#15e60e4c#;
   pragma Export (C, u00150, "system__img_lliS");
   u00151 : constant Version_32 := 16#0d8feb8c#;
   pragma Export (C, u00151, "system__img_lllbS");
   u00152 : constant Version_32 := 16#7e360bb4#;
   pragma Export (C, u00152, "system__img_llliS");
   u00153 : constant Version_32 := 16#07fbf280#;
   pragma Export (C, u00153, "system__img_lllwS");
   u00154 : constant Version_32 := 16#264c6bf5#;
   pragma Export (C, u00154, "system__img_llwS");
   u00155 : constant Version_32 := 16#08fa6212#;
   pragma Export (C, u00155, "system__img_wiuS");
   u00156 : constant Version_32 := 16#18ee5867#;
   pragma Export (C, u00156, "system__val_fltS");
   ...
   u00159 : constant Version_32 := 16#0414e57b#;
   pragma Export (C, u00159, "system__val_lfltS");
   u00160 : constant Version_32 := 16#34ab9f34#;
   pragma Export (C, u00160, "system__exn_lfltS");
   u00161 : constant Version_32 := 16#de111da4#;
   pragma Export (C, u00161, "system__val_llfS");
   u00162 : constant Version_32 := 16#19055f44#;
   pragma Export (C, u00162, "system__exn_llfS");
   u00163 : constant Version_32 := 16#e37e7d10#;
   pragma Export (C, u00163, "system__val_llliS");
   u00164 : constant Version_32 := 16#f82486d6#;
   pragma Export (C, u00164, "system__val_llluS");
   u00165 : constant Version_32 := 16#55af0444#;
   pragma Export (C, u00165, "urandprobeintB");
   u00166 : constant Version_32 := 16#77d61343#;
   pragma Export (C, u00166, "urandprobeintS");
